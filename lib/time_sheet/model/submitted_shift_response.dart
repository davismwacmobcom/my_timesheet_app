...
class SubmittedShiftListResponse {
  final bool success;
  final SubmittedShiftListData data;
  final String message;
  final int statusCode;
  final List<dynamic> errors;

  SubmittedShiftListResponse({
  ...
  factory SubmittedShiftListResponse.fromJson(Map<String, dynamic> json) {
    return SubmittedShiftListResponse(
      success: json["success"],
      data: SubmittedShiftListData.fromJson(json["data"]),
...
class SubmittedShiftListData {
  ...
  factory SubmittedShiftListData.fromJson(Map<String, dynamic> json) {
    return SubmittedShiftListData(
      data: (json["data"] as List)
          .map((e) => WeekData.fromJson(e))
          .toList(),
...
class WeekData {
  final String week;
  final String weekId;
  final List<ShiftSubmitted> shifts;
  ...
  factory WeekData.fromJson(Map<String, dynamic> json) {
    return WeekData(
      ...
      shifts: (json["shifts"] as List)
          .map((e) => ShiftSubmitted.fromJson(e))
          .toList(),
    );
  }
}

class ShiftSubmitted {
  final String id;
  final String date;
  ...
  factory ShiftSubmitted.fromJson(Map<String, dynamic> json) {
    return ShiftSubmitted(
      id: json["id"],
      date: json["date"],
